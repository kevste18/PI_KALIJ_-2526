...
public class DispositivoDAO {
    ...
    public boolean insertar(Dispositivo d) {
        String sql = "INSERT INTO dispositivo (mac, ip, modelo, sistema_operativo, id_dispo) VALUES (?, ?, ?, ?, ?)";
    ...
    public boolean actualizar(Dispositivo d) {
        String sql = "UPDATE dispositivo SET ip=?, modelo=?, sistema_operativo=?, id_dispo=? WHERE mac=?";
        try (PreparedStatement ps = con.prepareStatement(sql)) {
